...
--
-- TOC entry 4957 (class 0 OID 25610)
-- Dependencies: 225
...
--
-- TOC entry 4955 (class 0 OID 25597)
-- Dependencies: 223
-- Data for Name: courts; Type: TABLE DATA; Schema: public; Owner: raquettelover
--

INSERT INTO public.courts VALUES ('2025-09-12 10:00:10.548634', 1, 1, '2025-09-12 10:00:10.548634', 'Espace Tennis 10', 'Court de droite', 'TENNIS');


--
-- TOC entry 4960 (class 0 OID 25631)
-- Dependencies: 228
...
--
-- TOC entry 4958 (class 0 OID 25617)
-- Dependencies: 226
...
--
-- TOC entry 4956 (class 0 OID 25605)
-- Dependencies: 224
...
--
-- TOC entry 4959 (class 0 OID 25624)
-- Dependencies: 227
...
--
-- TOC entry 4961 (class 0 OID 25640)
-- Dependencies: 229
-- Data for Name: users_places; Type: TABLE DATA; Schema: public; Owner: raquettelover
--

INSERT INTO public.users_places VALUES ('2025-09-12 09:59:54.60021', 1, '2025-09-12 09:59:54.60021', 2);


--
-- TOC entry 4962 (class 0 OID 25645)
-- Dependencies: 230
...
SELECT pg_catalog.setval('public.courts_seq', 1, true);
...
SELECT pg_catalog.setval('public.places_seq', 1, true);
...
-- Completed on 2025-09-12 10:01:52
